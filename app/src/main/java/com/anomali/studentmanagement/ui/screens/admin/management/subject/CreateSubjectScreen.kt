...
@Composable
fun CreateSubjectScreen(navController: NavController, subjectRepository: SubjectRepository) {
                ...
                onClick = {
                    if (subjectName.isNotEmpty()) {
                        coroutineScope.launch {
                            isLoading = true
                            try {
                                subjectRepository.createSubject(name = subjectName)
                                Toast.makeText(
                                    context,
...
//    CreateSubjectScreen(navController = navController, subjectRepository = subjectRepository)
//}