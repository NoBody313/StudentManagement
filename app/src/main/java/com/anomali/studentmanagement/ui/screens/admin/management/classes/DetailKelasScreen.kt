...
fun DetailClassesScreen(
    ...
    var classes by remember { mutableStateOf<Classes?>(null) }
    ...
    LaunchedEffect(classesId) {
        isLoading = true
        try {
            val response = classesRepository.getClassById(classesId)
            if (response.isSuccessful) {
                classes = response.body()
                classesName = classes?.name ?: ""
            } else {
                ...
                Button(
                    onClick = {
                        coroutineScope.launch {
                            isLoading = true
                            try {
                                val response = classesRepository.deleteClass(classesId)
                                if (response.isSuccessful) {
                                    Toast.makeText(
                                        context,
